...
insert into investment_target (target_type, target_code, target_name, index_company, exchange_location,
                               exchange_location_mic, hold_or_not, valuation_method, trigger_value, trigger_percent, monitoring_frequency, holder, status, p_day)
values ('index', '399997','中证白酒','中证','sz','XSHE', 0, 'pe', 25, 30, 'daily', 'zhuangkun', 'active','2022-03-27');

insert into investment_target (target_type, target_code, target_name, index_company, exchange_location,
                               exchange_location_mic, hold_or_not, valuation_method, trigger_value, trigger_percent, monitoring_frequency, holder, status, p_day)
values ('index', '399396','国证食品饮料行业','国证','sz','XSHE', 0, 'pe', 25, 30, 'daily', 'zhuangkun', 'active', '2022-03-27');

insert into investment_target (target_type, target_code, target_name, index_company, exchange_location,
                               exchange_location_mic, hold_or_not, valuation_method, trigger_value, trigger_percent, monitoring_frequency, holder, status, p_day)
values ('index', '000932','中证800消费','中证','sz','XSHE', 0, 'pe', 25, 30, 'daily', 'zhuangkun', 'active', '2022-03-27');

insert into investment_target (target_type, target_code, target_name, index_company, exchange_location,
                               exchange_location_mic, hold_or_not, valuation_method, trigger_value, trigger_percent, monitoring_frequency, holder, status, p_day)
values ('index', '399965','中证800地产','中证','sz','XSHE', 0, 'pb', 0.9, 2, 'daily', 'zhuangkun', 'active','2022-03-27');

insert into investment_target (target_type, target_code, target_name, index_company, exchange_location,
                               exchange_location_mic, hold_or_not, valuation_method, trigger_value, trigger_percent, monitoring_frequency, holder, status, p_day)
values ('index', '399986','中证银行','中证','sz','XSHE', 0, 'pb', 0.9, 2, 'daily', 'zhuangkun', 'active', '2022-03-27');

insert into investment_target (target_type, target_code, target_name, index_company, exchange_location,
                               exchange_location_mic, hold_or_not, valuation_method, trigger_value, trigger_percent, monitoring_frequency, holder, status, p_day)
values ('index', '000036','中证上证消费','中证','sz','XSHE', 0, 'pe', 25, 30, 'daily', 'zhuangkun', 'active', '2022-03-27');



insert into investment_target (target_type, target_code, target_name, exchange_location,
                               exchange_location_mic, hold_or_not, valuation_method, trigger_value, trigger_percent, monitoring_frequency, holder, status, p_day)
values ('stock','000002','万科A','sz','XSHE',0,'pb',0.9,5,'minutely', 'zhuangkun', 'active','2022-03-27');

insert into investment_target (target_type, target_code, target_name, exchange_location,
                               exchange_location_mic, hold_or_not, valuation_method, trigger_value, trigger_percent, monitoring_frequency, holder, status, p_day)
values ('stock','600048','保利发展','sh','XSHG',0,'pb',0.89,20,'minutely', 'zhuangkun', 'active','2022-03-27');